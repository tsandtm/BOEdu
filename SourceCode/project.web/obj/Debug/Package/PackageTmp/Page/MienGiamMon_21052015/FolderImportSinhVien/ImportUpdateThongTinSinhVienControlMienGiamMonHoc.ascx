<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ImportUpdateThongTinSinhVienControlMienGiamMonHoc.ascx.cs"
    Inherits="project.web.Controls.ImportUpdateThongTinSinhVienControlMienGiamMonHoc" %>
<div class="ibox float-e-margins">
    <div class="ibox-content">
        <div class="steps-box clearfix">
            <div class="ghichu">
                Cập nhật thông tin Mã sinh viên và Mã lớp của Sinh viên xét miễn môn học
            </div>
                ...
                <div class="steps-content clearfix">
                    ...
                    <div class="steps-body">
                        <div class="">
                            ...
                            <div class="col-sm-9">
                                <div class="form-group">
                                    <a href="<%=ResolveUrl("~/") %>Resources/temp/Import_UpdateSinhVien.xls">ImportUpdateSinhVien</a>
