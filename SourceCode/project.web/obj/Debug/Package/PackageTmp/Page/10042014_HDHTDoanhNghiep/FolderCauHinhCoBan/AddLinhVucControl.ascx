...
--%>
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddLinhVucControl.ascx.cs"
    Inherits="project.web.Controls.AddLinhVucControl" %>
        ...
        <ContentTemplate>
            <div class="panel panel-default panel-popup">
                <div class="panel-heading">
                    <h3 class="panel-title">Thông tin lĩnh vực</h3>
                </div>
