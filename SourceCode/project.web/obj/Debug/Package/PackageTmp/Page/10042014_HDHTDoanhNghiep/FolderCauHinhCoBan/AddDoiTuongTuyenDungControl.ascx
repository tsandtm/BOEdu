...
--%>
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddDoiTuongTuyenDungControl.ascx.cs"
    Inherits="project.web.Controls.AddDoiTuongTuyenDungControl" %>
        ...
        <ContentTemplate>
            <div class="panel panel-default panel-popup">
                <div class="panel-heading">
                    <h3 class="panel-title">Thông tin đối tượng tuyển dụng</h3>
                </div>
