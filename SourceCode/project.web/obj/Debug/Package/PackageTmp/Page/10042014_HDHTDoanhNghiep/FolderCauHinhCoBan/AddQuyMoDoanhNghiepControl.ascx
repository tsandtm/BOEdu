...
--%>
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddQuyMoDoanhNghiepControl.ascx.cs"
    Inherits="project.web.Controls.AddQuyMoDoanhNghiepControl" %>
        ...
        <ContentTemplate>
            <div class="panel panel-default panel-popup">
                <div class="panel-heading">
                    <h3 class="panel-title">Thông tin quy mô</h3>
                </div>
