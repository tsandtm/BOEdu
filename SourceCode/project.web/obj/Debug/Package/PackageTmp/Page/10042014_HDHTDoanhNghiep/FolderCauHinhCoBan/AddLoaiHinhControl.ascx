...
--%>
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddLoaiHinhControl.ascx.cs"
    Inherits="project.web.Controls.AddLoaiHinhControl" %>
        ...
        <ContentTemplate>
            <div class="panel panel-default panel-popup">
                <div class="panel-heading">
                    <h3 class="panel-title">Thông tin loại hình</h3>
                </div>
