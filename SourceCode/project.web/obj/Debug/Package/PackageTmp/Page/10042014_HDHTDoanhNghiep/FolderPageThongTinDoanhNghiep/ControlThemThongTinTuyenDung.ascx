<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ControlThemThongTinTuyenDung.ascx.cs"
    Inherits="project.web.Page._10042014_HDHTDoanhNghiep.FolderQuanLyHopTac.ControlThemThongTinTuyenDung" %>
...
<div class="box-action">
    ...
    <div class="pull-right">
        <asp:LinkButton ID="buttonLuuTru" runat="server" ToolTip="Lưu trữ" CssClass="btn btn-add"
            OnClientClick="return validation_thongtintuyendung()"><i
...
<div class="wrapper animated fadeInRight">
            ...
            <div class="col-sm-4">
                <div>
                    <div class="input-group p-b-5">
                        <select id="selectBox" name="selectBox" class="form-control w-full">
                        </select>
                        <span class="input-group-btn">
                            <asp:Button ID="AddDoiTuong" OnClientClick="return AddDoiTuongClick()" Text="Thêm"
                                CssClass="btn btn-add btn-sm" runat="server" />
                        </span>
                    </div>
    ...
    <div class="form-horizontal">
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <div class="" id="data_tuyendung_TextBoxTuNgay">
            ...
            <div class="col-sm-4">
                <div class="" id="data_tuyendung_TextBoxDenNgay">
                    <div class="input-group date">
                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
    ...
    <div class="form-horizontal">
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <div id="summernote_tuyendung_mota_baongoai">
                    <div id="summernote_tuyendung_mota" runat="server" clientidmode="Static">
                    </div>
                </div>
                <asp:HiddenField ID="summernote_tuyendung_mota_dulieu" runat="server" ClientIDMode="Static" />
            </div>
        </div>
    </div>
                    ...
                    <asp:UpdatePanel ID="UpDatecollapseOne2" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">
                                        Tiêu đề<label class="text-danger">
                                            *</label>
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="" id="data_tuyendung_ngaykyfile">
                                            <div class="input-group date">
                                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="pull-right">
                                            <asp:Button runat="server" ID="buttonThemFile" CssClass="btn btn-primary btn-sm"
                                                Text="Thêm file" OnClientClick="return validation_thongtintuyendungfile()" />
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    function validation_thongtintuyendung() {
    ...
    function validation_thongtintuyendungfile() {
        if (!String.prototype.trim) {
            String.prototype.trim = function () {
                return this.replace(/^\s+|\s+$/g, '');
            };
...
//    });
    ...
    function AddDoiTuongClick() {
        ...
        var strValue = $('#selectBox').val();
        var strText = $('#selectBox :selected').text();
        ...
        if (strText != "") {
            ...
            if (lastValue != "") {
                ...
                $("#region_DoiTuong").append("<div class='chuongtvdiv'><button type='button' class='btn btn-outline btn-danger btn-sm' onclick=\"DeleteDoiTuong()\"><i class='fa fa-trash'>&nbsp;Xóa tất cả</i></button></div>");
                $("#region_DoiTuong").append("<span class='chuongtvdiv badge'><i>" + strText + "</i></span>");
            }
            $('#selectBox option[value=' + strValue + ']').remove();
        }
        return false;
    }
...
<script>
    function savetuyendungmota() {
        document.getElementById('summernote_tuyendung_mota_dulieu').value = $('#summernote_tuyendung_mota_baongoai .note-editor .note-editable').html();
    }
</script>
