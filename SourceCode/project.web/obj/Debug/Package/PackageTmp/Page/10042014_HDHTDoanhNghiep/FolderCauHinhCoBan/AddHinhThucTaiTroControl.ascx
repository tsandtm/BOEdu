...
--%>
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddHinhThucTaiTroControl.ascx.cs"
    Inherits="project.web.Controls.AddHinhThucTaiTroControl" %>
        ...
        <ContentTemplate>
            <div class="panel panel-default panel-popup">
                <div class="panel-heading">
                    <h3 class="panel-title">Thông tin hình thức tài trợ</h3>
                </div>
