...
--%>
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ControlThongTinThucTap.ascx.cs"
    Inherits="project.web.Controls.ControlThongTinThucTap" %>
<asp:UpdateProgress ID="UpdateProgress1" runat="Server" AssociatedUpdatePanelID="UpdatePanelShowThongTinHopTacThucTap_on">
    <ProgressTemplate>
...
<asp:UpdatePanel ID="UpdatePanelShowThongTinHopTacThucTap_on" runat="server" UpdateMode="Conditional"
