...
--%>
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddQuocGiaControl.ascx.cs"
    Inherits="project.web.Controls.AddQuocGiaControl" %>
        ...
        <ContentTemplate>
            <div class="panel panel-default panel-popup">
                <div class="panel-heading">
                    <h3 class="panel-title">Thông tin quốc gia</h3>
                </div>
