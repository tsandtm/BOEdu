...
--%>
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddNganhNgheControl.ascx.cs"
    Inherits="project.web.Controls.AddNganhNgheControl" %>
        ...
        <ContentTemplate>
            <div class="panel panel-default panel-popup">
                <div class="panel-heading">
                    <h3 class="panel-title">Thông tin ngành nghề</h3>
                </div>
