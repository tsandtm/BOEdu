...
--%>
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddTinhThanhControl.ascx.cs"
    Inherits="project.web.Controls.AddTinhThanhControl" %>
        ...
        <ContentTemplate>
            <div class="panel panel-default panel-popup">
                <div class="panel-heading">
                    <h3 class="panel-title">Thông tin tỉnh thành</h3>
                </div>
