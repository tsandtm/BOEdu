<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ListDoanhNghiepMoiControl.ascx.cs"
    Inherits="project.web.Page.FolderBaoCaoThongKe.ListDoanhNghiepMoiControl" %>
...
<asp:UpdatePanel ID="UpdatePanelShowDoanhNghiep" runat="server" UpdateMode="Conditional"
    ...
    <ContentTemplate>
        <asp:Panel ID="PanelFilter" runat="server" DefaultButton="ButtonSearch">
            <div class="row">
                <div class="col-sm-3 m-b-5 p-w-5" id="data_TuNgay_DoanhNghiepMoi">
                    <div class="input-group date w-full">
                        <span class="input-group-addon">Từ</span>
                        <asp:TextBox ID="txtFromDay" runat="server" CssClass="form-control"></asp:TextBox>
                    </div>
                </div>
                <div class="col-sm-3 m-b-5 p-w-5" id="data_DenNgay_DoanhNghiepMoi">
                    <div class="input-group date w-full">
