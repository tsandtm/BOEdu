...
{
    public partial class ControlLoggedUserInfo : System.Web.UI.UserControl
    {
        ...
        private void PopularLabels()
        {
            ...
            if (this.lblUser != null)
            {
                ...
                {
                    this.lblUser.Text = "<strong>" + loggedUser.Name + "</strong>";
                    this.lblID.Text = "[" + loggedUser.LoginName + "]";
