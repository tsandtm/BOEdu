...
--%>
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddCatologieControl.ascx.cs"
    Inherits="project.web.Controls.AddCatologieControl" %>
        ...
        <ContentTemplate>
            <div class="panel panel-default panel-popup">
                <div class="panel-heading">
                    <h3 class="panel-title">Chi tiết danh mục thông tin</h3>
                </div>
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <div class="form-group">
                                <asp:TextBox ID="TextBoxCatologyName" runat="server" CssClass="form-control w-full"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <div class="form-group">
                                <asp:TextBox ID="TextBoxDescription" runat="server" CssClass="form-control w-full"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <div class="form-group">
                                <asp:TextBox ID="TextBoxPosition" runat="server" CssClass="form-control w-full"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <div class="form-group">
                                <asp:DropDownList ID="DropDownListCatologies" runat="server" CssClass="form-control w-full">
                                </asp:DropDownList>
                            </div>
                        </div>
                    </div>
