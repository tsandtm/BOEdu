<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ImportCATControl.ascx.cs"
    Inherits="DA.Web.Controls.ImportData.ImportCATControl" %>
<style type="text/css">
    .ErrorRow{color:Red;}
    ...
    <div class="importcontent">
        ...
        <div class="block-small1">
            <div class="imgdulieumau">
                <a href="<%=ResolveUrl("~/") %>Resources/temp/Mau_import_SV.xls">
